...
\author Charles B. Owen
\version 02-03-2001 1.00 Declared version number
\version 03-23-2004 1.01 Visual Studio 2003 bug fixes, NOOPENGL option.
\version 03-11-2007 1.02 Allows for direct access to X, Y, Z, W.
Added MemberMultiply3. Added several additional set functions.
\version 01-22-2011 1.03 Change from CGrPoint to CGrVector
\version 01-28-2012 1.04 Documentation added.
\version 02-06-2012 1.05 Additional documentation added.
\version 02-19-2012 2.03 Declared single version number with CGrTransform.
                         Moved GR_ constants into this header from GrTransform.h.
                         CGrTranform constructor initializes to identity matrix.
*/
