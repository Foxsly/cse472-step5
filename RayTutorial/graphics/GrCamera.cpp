...
{
    m_eye[0] = p_eye[0];            m_eye[1] = p_eye[1];        m_eye[2] = p_eye[2];   m_eye[3] = 1;
    m_center[0] = p_center[0];            m_center[1] = p_center[1];        m_center[2] = p_center[2];  m_center[3] = 1;
    m_up[0] = p_up[0];            m_up[1] = p_up[1];        m_up[2] = p_up[2];  m_up[3] = 0;
